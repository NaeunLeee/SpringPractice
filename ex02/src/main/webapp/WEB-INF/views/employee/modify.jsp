	...
	<div class="col-lg-8">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						<form role="form" action="${pageContext.request.contextPath}/employee/modify" method="post">
						...
						<div class="form-group">
							<label>이메일</label>
							<textarea class="form-control" rows="3" name="email">${employee.email}</textarea>
						</div>
						<div class="form-group">
							<label>전화번호</label> 
						...
						<div class="form-group">
							...
							<div class="row" align="center">
								...
								<button type="submit" formaction="${pageContext.request.contextPath}/employee/delete" class="btn btn-default">삭 제</button>
