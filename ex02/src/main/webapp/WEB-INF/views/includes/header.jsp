                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                     ...
                     <!--    <li>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/employee/list"><i class="fa fa-user fa-fw"></i> 사 원</a>
                        </li>
                        <!-- 
                        <li>
                            <a href="${pageContext.request.contextPath}/board/register"><i class="fa fa-table fa-fw"></i> 등록</a>
                        </li>
                        <li>
